...
(function($) {
    ...
    function Plugin($container, options) {
        ...
        ,   $indic = $container.find("#indic")//$indic.css("transform", "rotate(30deg)");
        ...
        this.setColor = function(color) {
            ...
            colorData = Math.ceil(colorData[0]/2.55);
            $number.text(colorData+"%");
            
            if(colorData == 0)
                $indic.css("transform", "rotate(250deg)");
            else if(colorData == 100)
                $indic.css("transform", "rotate(-74deg)");
            else
                $indic.css("transform", "rotate("+(220-(colorData*2.60))+"deg)");
...
function initPage(receivedData)
{
    ...
    var percen255 = Math.floor(data.s*2.55);
    var decColor = "#"+((1 << 24) + (percen255 << 16) + (percen255 << 8) + percen255).toString(16).slice(1);
    ...
    $box.on("change", function(e, hex, rgb)
    {
    	...
    	data.s = Math.ceil(result[0]/2.55);
